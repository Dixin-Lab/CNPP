...
def predict_from_hidden(model, process_idx, h_t_vals, dt_vals, next_dt, next_type, plot, hmax: float = 40.,
                        n_samples=1000, print_info: bool = False):
    model.eval()
    timestep = hmax / n_samples

    intens_t_vals: Tensor = model.intensity_layer_list[process_idx](h_t_vals)
